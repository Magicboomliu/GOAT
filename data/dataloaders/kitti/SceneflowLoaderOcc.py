...
class StereoDatasetOcc(Dataset):
    def __init__(self, data_dir,
                 ...
                 transform=None):
        super(StereoDatasetOcc, self).__init__()
        ...
        for line in lines:
            ...
            gt_occlusion_left = None if len(splits)<4 else splits[4]
            ...
            sample['occu_left'] = os.path.join(data_dir,gt_occlusion_left) if gt_occlusion_left is not None else None 
