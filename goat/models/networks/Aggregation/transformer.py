...
from goat.models.networks.Aggregation.transformer_utils import split_feature, merge_splits
...
class SwinSelfAttentionTransformerBlock(nn.Module):
    """self attention + cross attention + FFN"""
    ...
    def __init__(self,
        ...
        super(SwinSelfAttentionTransformerBlock, self).__init__()
...
class SingleFeatureTransformer(nn.Module):
    def __init__(self,
        ...
        super(SingleFeatureTransformer, self).__init__()
...
class FeatureTransformerV2(nn.Module):
    def __init__(self,
        ...
        super(FeatureTransformerV2, self).__init__()
...
if __name__=="__main__":
    ...
    single_feature_transformer = SingleFeatureTransformer(num_layers=4,d_model=128,nhead=1,
                                                          attention_type='swin',ffn_dim_expansion=4).cuda()
    
    output = single_feature_transformer(left_feature,attn_num_splits=2)
