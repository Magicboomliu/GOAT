...
def feature_add_position(feature0, feature1, attn_splits, feature_channels):
    ...
    if attn_splits > 1:  # add position in splited window
        feature0_splits = split_feature(feature0, num_splits=attn_splits) # channel last = False
        feature1_splits = split_feature(feature1, num_splits=attn_splits) # channel last = False
